...
import bubble.test.ex14.BubbleFrame;
import bubble.test.ex14.EnermyWay;
import bubble.test.ex14.MoveAble;
...
public class Enermy extends JLabel implements MoveAble {
    ...
    private bubble.test.ex14.BubbleFrame mContext;
...
//        new Thread(new BackgroundEnermyService(this)).start();
    }
